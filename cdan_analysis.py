...
def main(args: argparse.Namespace):
    ...
    cdan = ConditionalDomainAdversial.load_from_checkpoint(
        checkpoint_path='lightning_logs/cdan/version_0/checkpoints/epoch=3-step=4880.ckpt',
        hparams_file="lightning_logs/cdan/version_0/hparams.yaml",
        map_location=None,
        backbone=backbone, 
        classifer=classifer, 
    ...
    visualize(src_features, trg_features, src_labels, trg_labels, os.path.join(args.visualize_dir, 'cdan_tsne.png'))
