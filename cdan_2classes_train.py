...
def main(args: argparse.Namespace):
    ...
    train_trg_loader = DataLoader(train_trg_dataset, batch_size=args.batch_size, shuffle=False, num_workers=8, sampler=RandomSubsetSampler(dataset_max_size, train_trg_index))
    ...
    test_src_loader = DataLoader(test_src_dataset, batch_size=2*args.batch_size, shuffle=False, num_workers=8, sampler=SubsetRandomSampler(test_src_index))
